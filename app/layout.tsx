...
export const metadata: Metadata = {
  ...
  description: "Sistema web responsivo para conferência de estoque com leitor de código de barras",
  ...
  keywords: ["estoque", "inventário", "código de barras", "conferência", "sistema", "stock", "warehouse"],
